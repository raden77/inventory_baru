...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Manages Merek</h3>
        </div>
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    {{-- <a href="{{ $create_url }}" class="btn btn-info btn-sm">New Merek</a> --}}
             ...
             <table class="table table-bordered table-hover" id="merek-table" width="100%">
                <thead>
                <tr class="bg-purple">
                    <th>Kode Merek</th>
                    <th>Nama Merek</th>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('kode_merek', null, ['class'=> 'form-control','id'=>'Kode1']) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('nama_merek', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required']) }}
                                    <span class="text-danger">
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            @include('errors.validation')
            {{-- {!! Form::open( ['route' => ['merek.ajaxupdate'],'method' => 'post','id'=>'Update']) !!} --}}
            {!! Form::open(['id'=>'EDIT']) !!}
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('kode ukuran', 'Kode Merek:') }}
                            {{ Form::text('kode_merek', null, ['class'=> 'form-control','id'=>'Kode']) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('nama merek', 'Nama Merek:') }}
                            {{ Form::text('nama_merek', null, ['class'=> 'form-control','id'=>'Nama']) }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            if (result) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        console.log(result);
                        $('#Kode').val(result.kode_merek);
                        $('#Nama').val(result.nama_merek);
