...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Manages Vendor</h3>
        </div>
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    {{-- <a href="{{ $create_url }}" class="btn btn-info btn-sm">New Vendor</a> --}}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('kode_vendor', null, ['class'=> 'form-control','id'=>'Kode1']) }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('nama_vendor', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required']) }}
                                    <span class="text-danger">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('Hp', 'Hp:') }}
                                    {{ Form::text('hp', null, ['class'=> 'form-control','id'=>'Hp1','required'=>'required']) }}
                                    <span class="text-danger">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('Termin Pembayaran', 'Termin Pembayaran:') }}
                                    {{ Form::text('termin_pembayaran', null, ['class'=> 'form-control','id'=>'Termin1','required'=>'required']) }}
                                    <span class="text-danger">
                                        <strong class="termin-error" id="termin-error"></strong>
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-4">
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            @include('errors.validation')
            {{-- {!! Form::open( ['route' => ['vendor.ajaxupdate'],'method' => 'post','id'=>'Update']) !!} --}}
            {!! Form::open(['id'=>'EDIT']) !!}
            <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('kode Vendor', 'Kode Vendor:') }}
                                {{ Form::text('kode_vendor', null, ['class'=> 'form-control','id'=>'Kode']) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('Nama Vendor', 'Nama Vendor:') }}
                                {{ Form::text('nama_vendor', null, ['class'=> 'form-control','id'=>'Nama']) }}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('Termin Pembayaran', 'Termin Pembayaran:') }}
                                {{ Form::text('termin_pembayaran', null, ['class'=> 'form-control','id'=>'Termin']) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
    ...
    <script>
        $(function() {
            ...
            columns: [
                ...
                { data: 'hp', name: 'hp' },
                { data: 'npwp', name: 'npwp' },
                { data: 'termin_pembayaran', name: 'termin_pembayaran' },
        ...
        $('#ADD').submit(function (e) {
            ...
            var termin = $.trim($('#Termin1').val());
            var status = $.trim($('#Status1').val());
            var registerForm = $("#ADD");
            var formData = registerForm.serialize();

            // Check if empty of not
            if (kode === '' || name === ''|| alamat === ''|| telp === ''|| hp === ''|| npwp === ''|| termin === ''|| status === '') {
                    if(kode === ''){
                    ...
                    if(hp === ''){
                        $( '.hp-error' ).html('Mohon di Isi');
                    }
                    if(npwp === ''){
                        $( '.npwp-error' ).html('Mohon di Isi');
                    }
                    if(termin === ''){
                        $( '.termin-error' ).html('Mohon di Isi');
                    }
                    if(status === ''){
            ...
            if (result) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        console.log(result);
                        $('#Kode').val(result.kode_vendor);
                        $('#Nama').val(result.nama_vendor);
                        $('#Alamat').val(result.alamat);
                        $('#Telp').val(result.telp);
                        $('#Hp').val(result.hp);
                        $('#Npwp').val(result.npwp);
                        $('#Termin').val(result.termin_pembayaran);
